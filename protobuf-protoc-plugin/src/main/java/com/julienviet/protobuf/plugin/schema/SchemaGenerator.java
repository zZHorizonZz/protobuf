 ...
 *
 */
package com.julienviet.protobuf.plugin.schema;
...
public class SchemaGenerator {
  ...
  public String generateFieldLiterals() {
    ...
    writer.println("  private com.julienviet.protobuf.schema.Type type;");
    ...
    writer.println("  }");
    writer.println("  public com.julienviet.protobuf.schema.Type type() {");
  ...
  public String generateMessageLiterals() {
    ...
    writer.println(";");
//    writer.println("  private static final java.util.List<java.util.function.Function<?, com.julienviet.protobuf.core.ProtoStream>> streamFactories = new java.util.ArrayList<>();");
    ...
    writer.println("  }");
//    writer.println("  public com.julienviet.protobuf.core.ProtoStream apply(Object o) {");
//    writer.println("    java.util.function.Function<Object, com.julienviet.protobuf.core.ProtoStream> fn = (java.util.function.Function<Object, com.julienviet.protobuf.core.ProtoStream>)streamFactories.get(ordinal());");
...
//      writer.println("    java.util.function.Function<" + decl.className + ", com.julienviet.protobuf.core.ProtoStream> fn_" + decl.name + " = " + javaPkgFqn + ".ProtoWriter::streamOf;");
