...
public enum Syntax {
  ...
  /**
   * Determines the syntax/edition from a FileDescriptor.
   * 
   * @param fileDescriptor the file descriptor to inspect
   * @return the syntax or edition of the file
   */
  public static Syntax fromFileDescriptor(Descriptors.FileDescriptor fileDescriptor) {
    return fromFileDescriptorProto(fileDescriptor.toProto());
  }

  /**
   * Determines the syntax/edition from a FileDescriptorProto.
   * 
   * @param proto the file descriptor proto to inspect
   * @return the syntax or edition of the file
   */
  public static Syntax fromFileDescriptorProto(DescriptorProtos.FileDescriptorProto proto) {
