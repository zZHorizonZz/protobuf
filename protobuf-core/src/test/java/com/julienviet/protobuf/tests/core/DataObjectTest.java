...
import com.julienviet.protobuf.tests.core.support.importing.Container;
import com.julienviet.protobuf.tests.core.support.importing.ImportingProto;
...
public class DataObjectTest {
  ...
  public void testReadSimple() {
    byte[] bytes = TestProto.SimpleMessage.newBuilder()
      ...
      .putMapStringInt32("the-key-2", 5)
      .build().toByteArray();
    com.julienviet.protobuf.tests.core.support.basic.ProtoReader reader = new com.julienviet.protobuf.tests.core.support.basic.ProtoReader();
  ...
  public void testWriteSimple() throws Exception {
    ...
    byte[] result = ProtobufWriter.encodeToByteArray(visitor -> {
      com.julienviet.protobuf.tests.core.support.basic.ProtoWriter.emit(value, visitor);
    });
  ...
  public void testReadImports() {
    ...
    com.julienviet.protobuf.tests.core.support.importing.ProtoReader reader = new com.julienviet.protobuf.tests.core.support.importing.ProtoReader();
    ProtobufReader.parse(com.julienviet.protobuf.tests.core.support.importing.MessageLiteral.Container, reader, bytes);
  ...
  public void testWriteImports() throws Exception {
    ...
    byte[] result = ProtobufWriter.encodeToByteArray(com.julienviet.protobuf.tests.core.support.importing.ProtoWriter.streamOf(container));
