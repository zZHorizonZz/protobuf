...
import com.julienviet.protobuf.core.interop.ProtoWriter;
import com.julienviet.protobuf.tests.core.support.interop.Container;
import com.julienviet.protobuf.tests.core.support.interop.InteropProto;
import com.julienviet.protobuf.tests.core.support.interop.MessageLiteral;
import com.julienviet.protobuf.tests.core.support.interop.ProtoReader;
...
public class InteropTest extends InteropTestBase {
  ...
  protected Container read(InteropProto.Container src) {
   ...
   com.julienviet.protobuf.tests.core.support.interop.ProtoReader reader = new ProtoReader();
  ...
  protected InteropProto.Container write(Container src) {
    byte[] bytes = ProtobufWriter.encodeToByteArray(v ->com.julienviet.protobuf.tests.core.support.interop.ProtoWriter.emit(src, v));
    try {
...
//    assertEquals(S2, S1);
  ...
  private void testDecodeDuration(long seconds, int nano) throws Exception {
    ...
    com.julienviet.protobuf.core.interop.ProtoReader builder = new com.julienviet.protobuf.core.interop.ProtoReader();
    ProtobufReader.parse(com.julienviet.protobuf.well_known_types.MessageLiteral.Duration, builder, bytes);
